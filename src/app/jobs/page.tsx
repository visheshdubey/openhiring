...
import AppHeader from "@/components/shared/navigation/header";
import { FilterOptions } from "@/src/entities/constants/job";
import FilterSideBar from "@/components/job-list/FilterSideBar";
import { Job } from "@/components/job-list/types";
import JobCard from "@/components/job-list/JobCard";
import JobSearchInput from "@/components/job-list/JobSearchInput";
                    ...
                    <div className="grow flex-col w-full flex gap-4 mt-6">
                        <div className="flex flex-col gap-2 rounded-lg bg-primary px-4 py-6 lg:px-8 lg:py-14 bg-[radial-gradient(circle,rgba(118,49,237,1)_16%,rgba(92,10,232,1)_100%)]">
                            ...
                            <span className="text-sm lg:text-base text-primary-foreground">
                                Explore the latest job openings and apply for the best job opportunities available
                                today!
                            </span>
